...
member2 = Member.create(first_name: 'Shereef', last_name: 'Bishay', gender: 'Male', start_date: '01/02/2012', birthdate: '1977/03/05')
member3 = Member.create(first_name: 'Jolana', last_name: 'Bishay', gender: 'Female', start_date: '01/10/2012', birthdate: '1978/11/19')
